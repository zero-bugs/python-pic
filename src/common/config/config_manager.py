...
class ConfigManager:
    ...
    def get_proxy_config():
        proxy_json = ConfigUtils.read_json_file(
            "{}/config/proxy.json".format(PROJECT_PATH)
        )
    ...
    @staticmethod
    def get_type():
        jconfig = ConfigUtils.read_json_file(
            "{}/config/app_config.json".format(PROJECT_PATH)
        )
        return jconfig["type"]
    ...
    def get_api_key():
        jconfig = ConfigUtils.read_json_file(
            "{}/config/api_list.json".format(PROJECT_PATH)
        )
